...
<html>
    ...
    <div class="container content boxed-layout">
        ...
        <div id="show-license" class="content scaffold-show" role="main">
            ...
            <f:display bean="license" />
            <g:form resource="${this.license}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.license}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
